...
public class ExposedTests {
    ...
    public void upHeapTest3(){
        ...
        System.out.print(testPriorityQueue.patients);
        System.out.print(truePatients);
        System.out.print(testPriorityQueue.nameToIndex);
        System.out.print(trueNameToIndex);
    ...
    public void containsTest3(){
        ...
        System.out.println(testPatients.patients);
        System.out.println(testPatients.nameToIndex);
        ArrayList<ERPriorityQueue.Patient> truePatients = makeDeepCopy(testPriorityQueue.patients);
        HashMap<String,Integer> trueNameToIndex = new HashMap<>(testPriorityQueue.nameToIndex);
    ...
    public void peekMinTest2(){
        ...
        System.out.println(truePatients);
        System.out.println(trueNameToIndex);
