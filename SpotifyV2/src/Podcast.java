...
public class Podcast{
    ...
    public Episode getEpisode(int pIndex) {
        if ((aEpisodes.size()-1) < pIndex ) throw new AssertionError();
    ...
    public class Episode implements Playable {
        ...
        public Episode clone() {
            try {
                ...
                Field title = Episode.class.getDeclaredField("aTitle");
                title.setAccessible(true);
                title.set(clone, aTitle);
                Field number = Episode.class.getDeclaredField("aEpisodeNumber");
                number.setAccessible(true);
                number.set(clone, aEpisodeNumber);
                return clone;
            }
        ...
        public boolean equals(Object o) {
            ...
            return aTitle.equalsIgnoreCase(ep.aTitle) && aEpisodeNumber == ep.aEpisodeNumber;
        }
